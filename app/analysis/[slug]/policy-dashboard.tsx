...
const PolicyDashboard: React.FC<{ analysis: AnalysisResult }> = ({
  analysis,
}) => {
  return (
        ...
        <div className="container mx-auto p-6">
          ...
          <Card>
            ...
            <CardContent>
              <p>
                ...
                {analysis.policyDetails.productName}
              </p>
              <p>
              ...
              <p>
                ...
                {analysis.policyDetails.productType}
              </p>
              <p>
              ...
              <p>
                ...
                {analysis.policyDetails.riders.join(", ")}
              </p>
            </CardContent>
          </Card>
          ...
          {/* Key Categories */}
          <Tabs
            defaultValue={analysis.keyCategories[0].title}
            className="w-full"
          >
